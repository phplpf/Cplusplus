...
LoginDoc.h，LoginDoc.cpp - 文档
这些文件包含 CLoginDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CLoginDoc::Serialize)。

LoginView.h，LoginView.cpp - 文档的视图
这些文件包含 CLoginView 类。
CLoginView 对象用于查看 CLoginDoc 对象。
